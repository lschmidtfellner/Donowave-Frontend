        ...
        <div className="w-10/12 mt-4 rounded-md py-2">
          <div className="w-full text-center">
            <h2 className="text-left text-3xl font-bold leading-9 tracking-tight text-black mb-10">
              DonoWave is a modern fundraising platform enabling users to create campaigns and donate using our own DonoCoin cryptocurrency. Leveraging the power of MetaMask wallet, we're revolutionizing philanthropy in the crypto era. Join us in making a difference, one DonoCoin at a time.
            </h2>
